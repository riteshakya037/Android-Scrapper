...
public class TeamScore {
    ...
    @SerializedName("current") @Expose private int current;

    @SerializedName("period1") @Expose private int period1;

    @SerializedName("normaltime") @Expose private int normaltime;
