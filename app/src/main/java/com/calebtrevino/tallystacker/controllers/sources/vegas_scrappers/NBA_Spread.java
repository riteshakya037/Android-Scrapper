...
public class NBA_Spread extends NBA {
    public static final Creator<NBA_Spread> CREATOR = new Creator<NBA_Spread>() {
        @Override public NBA_Spread createFromParcel(Parcel in) {
            return new NBA_Spread(in);
        }

        @Override public NBA_Spread[] newArray(int size) {
    ...
    @SuppressWarnings("UnusedParameters") private NBA_Spread(Parcel in) {
        // Empty Block
    }
    ...
    @Override public String getContraryPackageName() {
        return NBA_Total.class.getName();
    }
}
