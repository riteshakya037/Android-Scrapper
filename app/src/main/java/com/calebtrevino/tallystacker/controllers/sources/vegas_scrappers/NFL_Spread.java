...
public class NFL_Spread extends NFL {
    public static final Creator<NFL_Spread> CREATOR = new Creator<NFL_Spread>() {
        @Override public NFL_Spread createFromParcel(Parcel in) {
            return new NFL_Spread(in);
        }

        @Override public NFL_Spread[] newArray(int size) {
    ...
    @SuppressWarnings("UnusedParameters") private NFL_Spread(Parcel in) {
        // Empty Block
    }
    ...
    @Override public String getContraryPackageName() {
        return NFL_Total.class.getName();
    }
}
