...
public abstract class NCAA_BK extends LeagueBase {
    ...
    private final static String ESPN_URL = "http://www.espn.com/mens-college-basketball";
    private final static String NAME = "College BasketBall";
    private final static String BASE_URL =
            "http://www.vegasinsider.com/college-basketball/odds/las-vegas/";
    private final static String ACRONYM = "NCAA BK";
