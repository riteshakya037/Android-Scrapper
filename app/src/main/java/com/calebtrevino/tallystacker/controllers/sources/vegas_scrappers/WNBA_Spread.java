...
public class WNBA_Spread extends WNBA {
    public static final Creator<WNBA_Spread> CREATOR = new Creator<WNBA_Spread>() {
        @Override public WNBA_Spread createFromParcel(Parcel in) {
            return new WNBA_Spread(in);
        }

        @Override public WNBA_Spread[] newArray(int size) {
    ...
    @SuppressWarnings("UnusedParameters") private WNBA_Spread(Parcel in) {
        // Empty Block
    }
    ...
    @Override public String getContraryPackageName() {
        return WNBA_Total.class.getName();
    }
}
