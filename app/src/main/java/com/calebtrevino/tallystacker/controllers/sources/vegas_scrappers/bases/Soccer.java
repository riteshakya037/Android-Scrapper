...
public abstract class Soccer extends LeagueBase {
    ...
    private final static String NAME = "Soccer";
    private final static String ACRONYM = "Soccer";
    ...
    @Override public void createGameInfo(String bodyText, Game gameFromHtmlBlock) {
    ...
    @Override public SofaScoreboardParser getScoreBoardParser() throws ExpectedElementNotFound {
