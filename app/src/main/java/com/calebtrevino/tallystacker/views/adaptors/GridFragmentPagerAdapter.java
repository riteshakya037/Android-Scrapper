...
public class GridFragmentPagerAdapter extends FragmentStatePagerAdapter {
    ...
    private final int[] mTabsIcons = {
            R.drawable.ic_view_module_white_24px, R.drawable.ic_date_range_white_24px,
            R.drawable.ic_settings_white_24px
    };
    private final Context mContext;
    private final GridNameChangeListener listener;
    @SuppressWarnings("WeakerAccess") @BindView(R.id.title) protected TextView title;
    @SuppressWarnings("WeakerAccess") @BindView(R.id.icon) protected ImageView icon;

    public GridFragmentPagerAdapter(FragmentManager fm, Context context,
            GridNameChangeListener listener) {
        super(fm);
    ...
    public View getTabView(int position) {
        ...
        @SuppressLint("InflateParams") View view =
                LayoutInflater.from(mContext).inflate(R.layout.custom_tab, null);
